...
########################################################################################
    * :ref:`Code template <code_template>` 
    * :download:`Download <../../static_data/example_scripts/ruffus_template.py>` code


    This is the standard template we use for developing ruffus pipelines
